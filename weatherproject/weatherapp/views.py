...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=d5c1c644add7395eb011adaf71672055'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyC3IiMWuAhvYrMgfdpr9MlaSBUHiyYHJ78'

    SEARCH_ENGINE_ID = '409f811b1ac44448d'
